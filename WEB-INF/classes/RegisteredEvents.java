...
@WebServlet(name = "RegisteredEvents", urlPatterns = { "/RegisteredEvents" })
public class RegisteredEvents extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Event> events = dbObj.getRegisteredEvents(request);
        out.println("<html>");
        out.println("<head>");
        out.println("<title>Registered Events</title>");
        out.println("<style>");
        ...
        out.println("<h1>Registered Events</h1>");
        out.println("<div class='event-container'>");
        if (events.size() == 0) {
            out.println("<p>No events registered</p>");
        }
